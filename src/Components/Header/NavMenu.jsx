    ...
    return (
        <div className="fixed top-0 z-50 w-[83%]">
            ...
            <section className="px-[30px] text-[#4a4a4a] bg-white h-[60rem]">
                ...
                {categories?
                    <CategoriesItems categoriesFunction={CategoriesItems}/>
                    :
                <>
                    <button onClick={categoriesItems} className="flex py-[14px] w-full justify-between items-center">Categories<IoIosArrowForward size={21}/> </button>
